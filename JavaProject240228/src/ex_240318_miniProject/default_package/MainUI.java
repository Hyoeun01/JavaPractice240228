package ex_240318_miniProject.default_package;
...
public class MainUI {
	...
	public void initialize() {
		...
		rdbtnHall.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				clickInOut(coffee.getTakeout(),"매장",flag_inout);
				coffee.setTakeout("매장");
				showlabel(coffee.getName(),coffee.getPrice());
				flag_inout=true;
		...
		rdbtnHall.setBounds(469, 83, 80, 26);
		...
		rdbtnTakeout.addActionListener(new ActionListener() {
			...
			clickInOut(coffee.getTakeout(),"포장",flag_inout);
			coffee.setTakeout("포장");
			showlabel(coffee.getName(),coffee.getPrice());
			flag_inout=true;
		...
		rdbtnTakeout.setBounds(561, 83, 80, 26);
		panel_1.add(rdbtnTakeout);
		
		JRadioButton rdbtnTumbler = new JRadioButton("  텀블러");
		buttonGroup_3.add(rdbtnTumbler);
		rdbtnTumbler.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent e) {
				
				clickInOut(coffee.getTakeout(),"텀블러",flag_inout);
				coffee.setTakeout("텀블러");
				showlabel(coffee.getName(),coffee.getPrice());
				flag_inout=true;
		...
		rdbtnTumbler.setBounds(644, 83, 121, 26);
		panel_1.add(rdbtnTumbler);
		...
		label_2.setBounds(373, 86, 99, 18);
		panel_1.add(label_2);
	...
	public void showlabel(String name, int price){//판매 데이터 입력
		...
		if(coffee.getName() != null && coffee.getPrice() != 0 ){
			...
			if(coffee.getTakeout() != null){
				menu = menu+ " / " +coffee.getTakeout();
			}
		...
		if(flag_inout){
			...
			case "매장":
				...
				case "매장":
					...
					break;
				case "포장":
					coffee.setPrice(coffee.getPrice()+300);
					break;
				case "텀블러":
					coffee.setPrice(coffee.getPrice()+500);
					break;
			...
			case "포장":
				...
				case "포장":
					...
					break;
				case "텀블러":
					coffee.setPrice(coffee.getPrice()+200);
					break;
				default:
					break;
				}
